...
if ( ! class_exists( 'Cosmoswp_Template_Library_Charity' ) ) {
    ...
    class Cosmoswp_Template_Library_Charity extends Cosmoswp_Template_Library_Base{
        ...
        public function add_demo_template_library( $templates_list ){
            ...
            $demo_list = array(
                ...
                'demo-15' => array(
                    ...
                    'template_url' => array(
                        'content' => COSMOSWP_TEMPLATE_LIBRARY_URL.'includes/template-data/charity/charity-1/content.json',
                        'options' => COSMOSWP_TEMPLATE_LIBRARY_URL.'includes/template-data/charity/charity-1/options.json',
                        'widgets' => COSMOSWP_TEMPLATE_LIBRARY_URL.'includes/template-data/charity/charity-1/widgets.json'
                    ),
                    'screenshot_url' => COSMOSWP_TEMPLATE_LIBRARY_URL.'includes/template-data/charity/charity-1/screenshot.jpg',/*Screenshot of block*/

                    'demo_url' => 'https://www.demo.cosmoswp.com/demo-15/',/*Demo Url*/
                    'plugins' => array(
                        array(
                            'name'      => 'Gutentor',
                            'slug'      => 'gutentor',
...
Cosmoswp_Template_Library_Charity::get_instance()->run();