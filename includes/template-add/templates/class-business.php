...
if ( ! class_exists( 'Cosmoswp_Template_Library_Business' ) ) {
    ...
    class Cosmoswp_Template_Library_Business extends Cosmoswp_Template_Library_Base{
        ...
        public function add_demo_template_library( $templates_list ){
            ...
            $demo_list = array(
                'demo-1' => array(
                    ...
                    'template_url' => array(
                        'content' => COSMOSWP_TEMPLATE_LIBRARY_URL.'includes/template-data/business/business-1/content.json',
                        'options' => COSMOSWP_TEMPLATE_LIBRARY_URL.'includes/template-data/business/business-1/options.json',
                        'widgets' => COSMOSWP_TEMPLATE_LIBRARY_URL.'includes/template-data/business/business-1/widgets.json'
                    ),
                    'screenshot_url' => COSMOSWP_TEMPLATE_LIBRARY_URL.'includes/template-data/business/business-1/screenshot.jpg',/*Screenshot of block*/

                    'demo_url' => 'https://www.demo.cosmoswp.com/demo-1/',/*Demo Url*/
                ...
                'demo-101' => array(
                    ...
                    'keywords' => array( 'main', 'demo' ),/*Search keyword*/
                    'categories' => array( 'business' ),/*Categories*/
                    'screenshot_url' => COSMOSWP_TEMPLATE_LIBRARY_URL.'includes/template-data/business/business-pro-1/screenshot.jpg',/*Screenshot of block*/

                    'demo_url' => 'https://www.demo.cosmoswp.com/demo-101/',/*Demo Url*/
                ...
                'demo-124' => array(
                    'title' => __( 'Catering 1 ', 'cosmoswp' ),/*Title*/
                    'is_pro' => true,/*Premium*/
                    'pro_url' => 'https://www.cosmoswp.com/pricing/',/*Pro url*/
                    'type' => 'gutentor',/*Optional eg gutentor, elementor or other page builders*/
                    'author' => __( 'CosmosWP', 'cosmoswp' ),/*Author Name*/
                    'keywords' => array( 'main', 'demo' ),/*Search keyword*/
                    'categories' => array( 'business','catering','wedding' ),/*Categories*/
                    'screenshot_url' => COSMOSWP_TEMPLATE_LIBRARY_URL.'includes/template-data/catering/catering-pro-1/screenshot.jpg',/*Screenshot of block*/

                    'demo_url' => 'https://www.demo.cosmoswp.com/demo-124/',/*Demo Url*/
...
Cosmoswp_Template_Library_Business::get_instance()->run();