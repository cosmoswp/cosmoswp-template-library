...
if ( ! class_exists( 'Cosmoswp_Pro_Template_Library_Business' ) ) {
    ...
    class Cosmoswp_Pro_Template_Library_Business extends Cosmoswp_Template_Library_Base{
        ...
        public function add_demo_template_library( $templates_list ){
            ...
            $demo_list = array(
                array(
                    'title' => __( 'Business 101 ', 'cosmoswp' ),/*Title*/
...
Cosmoswp_Pro_Template_Library_Business::get_instance()->run();